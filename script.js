...
function formToPayload(form) {
  ...
  payload.append("email_subject", `New Hospera ${formType}`);
  payload.append("send_email", "true");
  payload.append("visitor_email", visitorEmail);
  payload.append("visitor_reply_subject", "Hospera Institute enquiry received");
  payload.append("visitor_reply_message", hosperaTrackingConfig.visitorAutoReply);
