...
const hosperaTrackingConfig = {
  ...
  trackerSyncUrl: "https://script.google.com/macros/s/AKfycbyKSDH7_KuHdJ6bJxQLGjs8fpdn9EHYB5pj9kCHi5tGUTQQu_5GJjpbeZM11NnJmfeHhQ/exec"
};
...
function sendTrackerPayload(payload) {
  ...
  try {
    return fetch(endpoint, {
      ...
      .catch((error) => {
        console.warn("Tracker sync request failed.", error);
        return false;
      });
  } catch (error) {
